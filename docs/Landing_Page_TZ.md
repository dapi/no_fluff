# Техническое задание: Посадочная страница NoFluff Bot
...
Создание современной mobile-first посадочной страницы для AI-ассистента NoFluff Bot, который фильтрует Telegram-каналы и экономит время пользователей. Целевая аудитория - IT-специалисты, предприниматели и профессионалы с высоким информационным потоком.
