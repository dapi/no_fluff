...
- [PRD-001: No Fluff Brownfield Baseline](PRD-001-no-fluff-brownfield-baseline.md)
  — governed conversion of the evidence intake: current product scope,
  provenance/confidence, retained conflicts and open ownership gaps without a
  delivery plan.
