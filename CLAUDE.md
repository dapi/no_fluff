...
- [Регламент работы со спецификациями](./docs/Specification_Workflow_Guide.md)
...
План имплементации всегда создается с нумерованными этапами и подпунктами
имеющие чекбоксы для загрузки в TODO.
